  ...
  render() {
    return (
      <div className="privacy">
        ...
        <p>
          AuthStarter, dba AuthStarter Inc. (the "Company") respects the privacy
          concerns of the users of its website, and the services provided
          therein (the "Site"). The Company thus provides this privacy statement
          to explain what information is gathered during a visit to the Site and
        ...
        <p>
          ...
          national security or law enforcement requirements. Please that this
          privacy policy only concerns the processing for which the Company is
          data controller. If you have any questions regarding personal data
          contained in the Third-Party Content, please contact the third-party
          provider responsible for such Third Party Content.
        </p>
        <p>
          <strong>Children Age 16 and Under:</strong>
          The Company recognizes the special obligation to protect personally
          identifiable information obtained from children age 16 and under. AS
          SUCH, IF YOU ARE 16 YEARS OLD OR YOUNGER, THE COMPANY REQUESTS THAT
          YOU NOT SUBMIT ANY PERSONAL INFORMATION TO THE SITE OR TO THE COMPANY.
          If the Company discovers that a child age 16 or younger has signed up
          on the Site or provided us with personally identifiable information,
          we will delete that child's identifiable information from our records.
        </p>
        <p>
        ...
        <p>
          ...
          any other party. Most browsers are initially set up to accept cookies.
          You can, however, reset your browser to refuse all cookies or indicate
          when a cookie is being sent. Please consult the technical information
        ...
        <p>
          <strong>Malware/Spyware/Viruses:</strong>
          Neither the Company nor the Site knowingly permit the use of malware,
          spyware, viruses, and/or other similar types of software.
        </p>
        <p>
          <strong>Links to External Sites:</strong>
          The Company is not responsible for the content or practices of third
          party websites that may be linked to the Site. The Company is also not
          responsible for any information that you might share with such linked
          websites. You should refer to each website's respective privacy policy
          and practices prior to disclosing any information.
        </p>
        <p>
          <strong>Bulletin Boards and Chat Areas:</strong>
          Guests of the Site are solely responsible for the content of messages
          they post on the Company's forums, such as chat rooms and bulletin
          boards. Users should be aware that when they voluntarily disclose
          personal information (e.g., user name, e-mail address, phone number)
          on the bulletin boards or in the chat areas, that information can be
        ...
        <p>
          ...
          The Site may provide you the opportunity to opt-in to receive
          communications from us at the point where we request information about
          you. You always have the option of removing your name from any e-mail
          list in order to discontinue any such future communications. In order
          to ensure immediate removal from any list, please follow the specific
          instructions set forth within the communications you receive from the
          Company which you no longer wish to receive. If you are unsuccessful
          in completing the instructions specified in any such communication,
          please e-mail us at [INSERT COMPANY EMAIL HERE], including a copy of
          the undesired email attached to the request, and state you wish to be
        ...
        <p>
          ...
          to [INSERT COMPANY EMAIL HERE] with the subject line: "Personal
          ...
          wish to delete your user account(s), please email us at [INSERT
          COMPANY EMAIL HERE] with the words "Delete Account" in the subject
          line. If you do not have a user account and wish to delete your email
          address or other personally identifiable information that you might
          have provided through your use of the Site, any Games, and/or any
          Services, please email us at [INSERT COMPANY EMAIL HERE] with the
          words "Delete My Information" in the subject line.
        </p>
        <p>
          ...
          please contact us at [INSERT COMPANY EMAIL HERE] with the words
          "Privacy Request" in the subject line.
        </p>
        <p>
          <strong>Your California Privacy Rights:</strong> California Civil Code
          Section 1798.83 permits California residents to request from companies
          conducting business in California a list of third parties to which the
          company has disclosed personally identifiable information during the
          preceding year for direct marketing purposes. Company has not and will
          not share your personally identifiable information with third parties
          for their direct marketing purposes; accordingly, it will not maintain
          such a list of third parties. If you are a resident of California and
          want additional information confirming how Company does not share your
          personally identifiable information with third parties for their
          direct marketing purposes, you may contact us at [INSERT COMPANY EMAIL
          HERE] with the words "California Privacy" in the subject line of your
          email.
        </p>
        <p>
          Contact Information for Complaints or Concerns: If you have any
          complaints or concerns about the Company or about this privacy
          statement, please contact:
        </p>
        <p>
          <strong>Via email:</strong>
          <br />
          INSERT COMPANY EMAIL HERE
        </p>
        <p>or</p>
        <p>
          <strong>Via regular mail:</strong>
          <br />
          AuthStarter
          <br />
          Attn: Privacy Policy/Legal <br />
          MY ADDRESS
          <br />
          SOMEWHERE
          <br />
        ...
        <p>
          Your Acceptance of These Terms: By using the Site, you accept the
          policies and restrictions set forth in this Online Privacy Policy. If
          you do not agree to this policy, please do not use the Site. This
          Online Privacy Policy may be revised from time to time by updating
          this posting. You are bound by any such revisions and should therefore
          periodically visit this page to review the then current Online Privacy
          Policy to which you are bound.
        </p>
        <p>
          <strong>Last Updated: August 8, 2018</strong>
        </p>
      </div>
    )
  }
